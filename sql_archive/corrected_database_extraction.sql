-- Complete Database Extraction (CORRECTED VERSION)
-- Generated: 2025-09-16
-- This file contains EVERYTHING needed to recreate the database
-- Fixed GROUP BY errors
...
-- ==============================================
-- 3. ALL CONSTRAINTS (FIXED GROUP BY)
-- ==============================================
...
SELECT 'SUMMARY:' as summary_type,
       'Functions: ' || COUNT(*) as summary_info
FROM pg_proc p
JOIN pg_namespace n ON p.pronamespace = n.oid
...
SELECT 'SUMMARY:' as summary_type,
       'Triggers: ' || COUNT(*) as summary_info
FROM information_schema.triggers
WHERE trigger_schema = 'public';
