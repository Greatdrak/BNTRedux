-- WORKING Database Extraction Script
-- Run this in Supabase SQL Editor to get EVERYTHING
-- This version actually extracts the data instead of just printing markers
