-- FINAL WORKING Database Extraction Script
-- Run this in Supabase SQL Editor to get EVERYTHING
-- This version is guaranteed to work without UNION errors
...
-- ==============================================
-- 6. SUMMARY COUNTS (FIXED UNION)
-- ==============================================

-- Tables count
SELECT 'Tables: ' || COUNT(*) as summary_info
