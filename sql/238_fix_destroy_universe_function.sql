-- Migration: 238_fix_destroy_universe_function.sql
-- Fix the destroy_universe function to only reference tables that actually exist

-- First, let's check what tables actually exist and update the function accordingly
-- The function should handle missing tables gracefully
...
BEGIN
  ...
  BEGIN
    ...
    -- Delete from trades table (if it exists)
    BEGIN
    ...
    -- Delete from combats table (if it exists)
    BEGIN
    ...
    -- Delete from visited table (if it exists)
    BEGIN
    ...
    -- Delete from scans table (if it exists)
    BEGIN
    ...
    -- Delete from favorites table (if it exists)
    BEGIN
    ...
    -- Delete from inventories table (if it exists)
    BEGIN
    ...
    -- Delete from ai_player_memory table (if it exists)
    BEGIN
    ...
    -- Delete from player_rankings table (if it exists)
    BEGIN
    ...
    -- Delete from ranking_history table (if it exists)
    BEGIN
    ...
    -- Delete from trade_routes table (if it exists)
    BEGIN
    ...
    -- Delete from route_executions table (if it exists)
    BEGIN
    ...
    -- Delete from route_waypoints table (if it exists)
    BEGIN
    ...
    -- Delete from route_profitability table (if it exists)
    BEGIN
    ...
    -- Delete from universe_settings table (if it exists)
    BEGIN
