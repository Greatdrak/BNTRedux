-- Simple diagnostic function to check AI player status
-- This will help us understand why the debug function is failing
...
BEGIN
  ...
  RETURN jsonb_build_object(
    ...
    'sample_player', COALESCE(v_sample_player, 'no_ai_players_found')
  );
END;
$$;
