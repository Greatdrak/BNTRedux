...
\restrict CvRJ9tiVgHOagQ3LFjgsntWcvIfCCpsMRssbjnP4SJoYpVzGWkj7gowPhkc2HZO
...
CREATE OR REPLACE FUNCTION "public"."create_universe"("p_name" "text" DEFAULT 'Alpha'::"text", "p_port_density" numeric DEFAULT 0.30, "p_planet_density" numeric DEFAULT 0.25, "p_sector_count" integer DEFAULT 500, "p_ai_player_count" integer DEFAULT 0) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_universe_id UUID;
...
ALTER FUNCTION "public"."create_universe"("p_name" "text", "p_port_density" numeric, "p_planet_density" numeric, "p_sector_count" integer, "p_ai_player_count" integer) OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."ships" (
    ...
    "shield_max" integer GENERATED ALWAYS AS ((20 * GREATEST("shield_lvl", 0))) STORED,
    ...
    CONSTRAINT "ships_shield_range" CHECK ((("shield" >= 0) AND ("shield" <= "shield_max")))
);
...
ALTER TABLE ONLY "public"."inventories"
    ADD CONSTRAINT "inventories_player_id_key" UNIQUE ("player_id");
...
CREATE OR REPLACE TRIGGER "warp_limit_trigger" BEFORE INSERT ON "public"."warps" FOR EACH ROW EXECUTE FUNCTION "public"."check_warp_count"();
...
ALTER TABLE ONLY "public"."inventories"
    ADD CONSTRAINT "inventories_player_id_fkey" FOREIGN KEY ("player_id") REFERENCES "public"."players"("id") ON DELETE CASCADE;
...
GRANT ALL ON FUNCTION "public"."calculate_price_multiplier"("current_stock" integer, "base_stock" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_price_multiplier"("current_stock" integer, "base_stock" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_price_multiplier"("current_stock" integer, "base_stock" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."check_warp_count"() TO "anon";
GRANT ALL ON FUNCTION "public"."check_warp_count"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."check_warp_count"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."create_universe"("p_name" "text", "p_port_density" numeric, "p_planet_density" numeric, "p_sector_count" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."create_universe"("p_name" "text", "p_port_density" numeric, "p_planet_density" numeric, "p_sector_count" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_universe"("p_name" "text", "p_port_density" numeric, "p_planet_density" numeric, "p_sector_count" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."create_universe"("p_name" "text", "p_port_density" numeric, "p_planet_density" numeric, "p_sector_count" integer, "p_ai_player_count" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."create_universe"("p_name" "text", "p_port_density" numeric, "p_planet_density" numeric, "p_sector_count" integer, "p_ai_player_count" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_universe"("p_name" "text", "p_port_density" numeric, "p_planet_density" numeric, "p_sector_count" integer, "p_ai_player_count" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."execute_trade_route"("p_user_id" "uuid", "p_route_id" "uuid", "p_max_iterations" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."execute_trade_route"("p_user_id" "uuid", "p_route_id" "uuid", "p_max_iterations" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."execute_trade_route"("p_user_id" "uuid", "p_route_id" "uuid", "p_max_iterations" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."game_hyperspace"("p_user_id" "uuid", "p_target_sector_number" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."game_hyperspace"("p_user_id" "uuid", "p_target_sector_number" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."game_hyperspace"("p_user_id" "uuid", "p_target_sector_number" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."game_move"("p_user_id" "uuid", "p_to_sector_number" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."game_move"("p_user_id" "uuid", "p_to_sector_number" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."game_move"("p_user_id" "uuid", "p_to_sector_number" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."game_ship_upgrade"("p_user_id" "uuid", "p_attr" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."game_ship_upgrade"("p_user_id" "uuid", "p_attr" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."game_ship_upgrade"("p_user_id" "uuid", "p_attr" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."game_trade"("p_user_id" "uuid", "p_port_id" "uuid", "p_action" "text", "p_resource" "text", "p_qty" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."game_trade"("p_user_id" "uuid", "p_port_id" "uuid", "p_action" "text", "p_resource" "text", "p_qty" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."game_trade"("p_user_id" "uuid", "p_port_id" "uuid", "p_action" "text", "p_resource" "text", "p_qty" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_leaderboard"("p_universe_id" "uuid", "p_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_leaderboard"("p_universe_id" "uuid", "p_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_leaderboard"("p_universe_id" "uuid", "p_limit" integer) TO "service_role";
...
\unrestrict CvRJ9tiVgHOagQ3LFjgsntWcvIfCCpsMRssbjnP4SJoYpVzGWkj7gowPhkc2HZO
