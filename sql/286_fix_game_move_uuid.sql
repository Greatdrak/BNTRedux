-- Migration: 286_fix_game_move_uuid.sql
-- Fix game_move to use sector UUIDs consistently and avoid integer=uuid comparisons
...
BEGIN
  ...
  -- Track a turn spent for leaderboard/activity
