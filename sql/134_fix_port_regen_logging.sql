-- Fix port regeneration function to return proper field names for logging
-- The cron heartbeat expects ports_regenerated and ports_decayed fields
...
-- Create the corrected version with proper return fields
