-- Enhance turn generation RPC to return more detailed statistics
-- This will help with monitoring and debugging turn generation

-- Drop the existing function first since we're changing the return type
DROP FUNCTION IF EXISTS public.generate_turns_for_universe(uuid, integer);
...
-- Grant permissions
GRANT EXECUTE ON FUNCTION public.generate_turns_for_universe(uuid, integer) TO authenticated;
GRANT EXECUTE ON FUNCTION public.generate_turns_for_universe(uuid, integer) TO service_role;

-- Set ownership
ALTER FUNCTION public.generate_turns_for_universe(uuid, integer) OWNER TO postgres;
